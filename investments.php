                                                ...
                                                <div class="col">
                                                    ...
                                                    <form class="user" action="updatefunds.php" method="POST">
                                                        <div class="form-group">
                                                            <input type="number" name="addfund" class="form-control form-control-user" id="addFunds" placeholder="$0.00">
                                                        </div>
                                            ...
                                            <div class="dropdown mb-4">
                                                ...
                                                <form action="pie.php" method="POST" class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                                                    <button type="submit" class="btn btn-primary btn-user btn-block" name="agg">Aggresive</a>
                                                        <button type="submit" class="btn btn-primary btn-user btn-block" name="mod">Moderate</a>
                                                            <button type="submit" class="btn btn-primary btn-user btn-block" name="con">Conservative</a>
                                                </form>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Stocks/ETFs
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Bonds
                                        </span>
                                        <span class="mr-2">
